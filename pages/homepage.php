  ...
  <?php
    ...
    <div id="mainContent">
      ...
      <p>
        ...
        colui che in campo mantiene il rispetto delle regole e la correttezza tra le due squadre. Essere arbitro significa
        concentrazione,
        sudore, tanti sacrifici e saper prendere decisioni difficili assumendosi la responsabilità delle proprie scelte.
        Essere arbitro significa
        rendere unico ogni momento di gioco assicurando alle squadre coinvolte e al pubblico un'esperienza di gioco leale
        e corretta.
      </p>
      ...
      <p>
        Abbiamo deciso di creare questo sito per permettere agli arbitri di qualsiasi categoria di avere un'unico potente
        mezzo per poter
        svolgere le attività burocratiche legate a questo splendido lavoro. Se sei un arbitro ma non hai ancora un account
        sulla nostra
      ...
      <p>
        In questa piattaforma, dopo aver effettuato il <a href="./login.html">login</a>, potrai accedere a numerose ed
        utilissime
      ...
      <p>
        In questa pagina potrai compilare il referto per una partita da te precedentemente arbitrata inserendo in maniera
        semplice
        ed intuitiva i giocatori presenti, il numero di falli, eventuali marcatori, ammonizioni ed espulsioni ed il minuto
        nel quale sono
        avvenute.
      </p>
      ...
      <p>
        In questa pagina potrai visualizzare le partite che hai arbitrato e refertato ordinate partendo adlla più recente,
        inoltre
      ...
      <div>
        <p>
          ...
          cliccando su questo <a href="./request.html">link</a> utile ad inoltrare la tua richiesta per diventare uno di
          noi!
        </p>
      </div>
